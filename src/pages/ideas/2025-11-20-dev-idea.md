...
title: Relate cell-cell junction remodeling to migration onset (dev example)
...
materialsAndMethods:
  ...
  software:
    - softwareTool:
        name: CoolSoftware
        instructions: >
          Do things with data by following instructions written in one programming language compiled to another language and probably run in a browser on a laptop.
        link: https://github.com/aics/junction-tracker
    - softwareTool:
        name: ADiffererntCoolSoftware
        instructions: >
          Do things with data by following instructions written in one programming language compiled to another language and probably run in a browser on a laptop.
